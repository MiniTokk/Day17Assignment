...
const SelectedSection: React.FC<SectionNavigationProps> = props => {
    ...
    const DrawList: React.FC<{}> = () => {
        ...
        return (
            <View style={styles.middleAppTextContainer}>
                <AppText style={styles.middleAppText}>There is nothing here :(</AppText>
                <AppText style={styles.psText}>Press Add Button Below to add tasks in your section!</AppText>
            </View>
        );
    }
