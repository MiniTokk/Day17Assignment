    ...
    return (
        <View style={[customStyle.customDrawerContainer, { backgroundColor: props.theme.primary }]}>
            <View style={customStyle.headerContainer}>
                <AppText style={customStyle.headerText} isNavigation={true}>Task Manager</AppText>
            </View>
...
const Sidebar: React.FC<{}> = () => {
    ...
    return (
        <Navigate.Navigator drawerContent={(props: any) => <CustomDrawerContent theme={theme} {...props} />} screenOptions={navigatorStyle} initialRouteName='Sections'>
            <Navigate.Screen name='Sections' component={AppRoutes} />
            <Navigate.Screen name='FinishedTasks' component={FinishedTasksRoutes} />
